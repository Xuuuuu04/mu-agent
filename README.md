...
一个自托管的个人 AI 代理。有人格、有持久记忆、能自己决定何时醒来、能自己造工具。通过微信、CLI 或 Web 跟你交互。
...
- **工具可生长**:内置 17 个工具,能自己造新工具热加载,能连外部 MCP server
...
文件读写、shell、网页抓取、web_search、message_send(主动发消息)、schedule_wake、记忆管理(save/search/update/forget)、承诺管理、知识笔记、意识流备注、tool_create(自造工具)。
